public class Main {
    public static void main(String[] args) {
        ...
        // it will print all of the animals' sounds and their products depending on whether they are male or female
    }
}
...
class Pig extends Animal {
    ...
    public void makeSound() {
        System.out.println(name + " the pig says: Oink!");
    }
    public String getProduct() {
        if (gender.equalsIgnoreCase("female")) {
            return "Piglets";
